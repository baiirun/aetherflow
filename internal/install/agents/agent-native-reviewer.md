---
description: "Reviews code to ensure features are agent-native — any user action has an agent equivalent, and agents have full context parity. Use when adding new features or UI workflows."
mode: subagent
temperature: 0.1
---
